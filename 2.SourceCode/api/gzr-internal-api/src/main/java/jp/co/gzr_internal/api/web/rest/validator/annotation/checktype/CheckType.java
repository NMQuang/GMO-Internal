...
/**
 * Validator to check is date valid.
 *
 * @author VuDA
 */
@Documented
@Constraint(validatedBy = {CheckTypeValidator.class})
@Target({METHOD, FIELD})
@Retention(RUNTIME)
public @interface CheckType {
     ...
     * @return the string
     */
    String type() default Contants.CONST_STR_BLANK;
     ...
     * @return the string
     */
    String defaultValue() default Contants.CONST_STR_BLANK;
    ...
    /**
     * Defines several {@link CheckType} annotations on the same element.
     *
